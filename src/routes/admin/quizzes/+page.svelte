...
<div class="container mx-auto p-4">
  <div class="max-w-4x2 mx-auto bg-white rounded-xl shadow-lg p-8">
    <h1 class="text-2xl font-bold mb-6 text-gray-700">Quiz Management</h1>

    <!-- Create Quiz Form -->
    <form method="POST" action="?/create" use:enhance class="mb-8 bg-white p-6 rounded-lg shadow">
    ...
    <div class="mb-4 flex flex-wrap gap-4">
      ...
      <div>
        <label for="searchDifficulty" class="block text-sm font-medium">Filter by Difficulty</label>
        <select
          id="searchDifficulty"
