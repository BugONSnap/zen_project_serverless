        ...
        <div class="space-y-3">
          ...
          <div>
            <div class="relative">
              ...
              <button
                type="button"
                class="absolute right-1 top-1/2 -translate-y-1/2 z-20 p-2 text-gray-400 hover:text-amber-400 active:text-amber-500 transition-colors focus:outline-none cursor-pointer touch-manipulation"
