...
ALTER TABLE "users" ADD COLUMN "unique_info" text NOT NULL;--> statement-breakpoint
ALTER TABLE "users" ADD COLUMN "created_at" timestamp DEFAULT now();--> statement-breakpoint
ALTER TABLE "users" ADD COLUMN "total_points" integer DEFAULT 0;--> statement-breakpoint
ALTER TABLE "users" ADD COLUMN "rank_id" integer;--> statement-breakpoint
ALTER TABLE "users" ADD COLUMN "admin_level" integer DEFAULT 2 NOT NULL;--> statement-breakpoint
...
ALTER TABLE "users" ADD CONSTRAINT "users_rank_id_user_rankings_id_fk" FOREIGN KEY ("rank_id") REFERENCES "public"."user_rankings"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
